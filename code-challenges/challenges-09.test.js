...
function transformToLis(obj){
  // Solution code here...
 const pairs= Object.entries(obj).map(value =>(`<li>${value.join(': ')}</li>`));
  return pairs;
}
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
...
const addValues = (arr) => {
  // Solution code here...
  const addValue = arr.reduce((acc , value )=>{
    return acc +value;
 },0);
 return addValue;
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  const numberOfElements = arr.reduce((acc)=>{    
   return acc+1;
  },0)
...
const returnNames = (arr) => {
  // Solution code here...
  const characters = arr.reduce((acc, value)=> {
    acc.push(value.name);
    return acc;
  }, [])
  return characters;
...
const reversedString = (str) => {
  ...
  const reverses = reverse.reduce((acc,value)=>{ return value+acc; },'')
  return reverses;
};
